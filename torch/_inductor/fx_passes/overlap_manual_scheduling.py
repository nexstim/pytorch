...
class Container:
    """
    A hierarchical container for organizing and managing torch.fx nodes by their module stack.

    This class provides a tree-like structure where each node in the hierarchy corresponds
    to a module or submodule in a traced FX graph. Each `Container` instance can hold a list
    ...
    Attributes:
        ...
        children (dict[str, Container]): A mapping of child module names to their corresponding Container instances.
    """
